...
public class CayAdapter extends FirebaseRecyclerAdapter<CayXanhModel, CayAdapter.myViewHolder> {
     ...
     * @param options
     */
    public CayAdapter(@NonNull FirebaseRecyclerOptions<CayXanhModel> options, Context mcontext) {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull myViewHolder holder,final @SuppressLint("RecyclerView") int position, @NonNull CayXanhModel model) {
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cay_xanh_item,parent,false);
