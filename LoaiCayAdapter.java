...
public class LoaiCayAdapter extends BaseAdapter {

    private Context context;
    private int layout;
    private List<LoaiCay> loaiNhacList;

    public LoaiCayAdapter(Context context, int layout, List<LoaiCay> loaiDongVatList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        LoaiCay loaiNhac = loaiNhacList.get(i);
